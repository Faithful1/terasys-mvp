...
const structure = [
  ...
  { id: 1, label: 'User', link: '/app/user', icon: <TypographyIcon /> },
  { id: 2, label: 'Device', link: '/app/device', icon: <TableIcon /> },
  { id: 3, label: 'Data', link: '/app/tables', icon: <NotificationsIcon />},
  {
    id: 4,
